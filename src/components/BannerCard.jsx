    ...
    <section id="banner" className="bg-gray-900 py-8 relative overflow-hidden" aria-label="Главный баннер">
      <div className="container mx-auto px-4 pt-24 pb-8">
        ...
        <div className="flex flex-col md:flex-row">
          {/* Текст слева */}
          <div className="flex-1 flex items-center p-8 md:p-12 animate-fade-in-up">
            <div>
          ...
          {/* Иконка справа */}
          <div className="flex-1 min-h-[400px] md:min-h-[500px] flex items-center justify-center p-8 md:p-12 relative">
            {/* Анимированный фон */}
